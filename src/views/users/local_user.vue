<template>
  <div class="btn">
    <input type="text" v-model="roomId" placeholder="请输入房间号ID" maxlength="40">
...
function createPeerConnection() {
  ...
  localStream.value.getTracks().forEach((track:any) => pc.addTrack(track, localStream.value))
}
